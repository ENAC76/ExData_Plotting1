...
par(mfrow=c(2,2))
with(hhpc2, plot( Date_time, Global_active_power, ylab="Global Active Power (Kilowatts)", xlab="",type="l"))
with(hhpc2, plot( Date_time, Voltage, ylab="Voltage", xlab="datetime",type="l"))
...
with(hhpc2, plot( Date_time, Global_reactive_power, ylab="Global_reactive_power", xlab="datetime",type="l"))
